...
const questions = [
    ...
    },
    {
        ...
        default : "Step1: Run npm install and Step2: Run npm axios --save and Step3: Run node index.js",
    },
    {
        type: "input",
        name : "usage",
...
function init() {
    inquirer.prompt(questions).then(answers =>{
        ...
        .then(response => {
            ...
            const selectedLicense = badges[answers.license];
            fs.writeFile("README.md", generateMarkdown(answers, selectedLicense), function (err) {
                if (err) {
                    throw (err);
                }
